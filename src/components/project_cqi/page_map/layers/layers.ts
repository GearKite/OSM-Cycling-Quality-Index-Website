...
export const layerSelection: {
  ...
  {
    key: 'cqi',
    name: 'Riteņbraukšanas kvalitātes indekss',
    description: 'Indeksa vērtības no 0 līdz 100',
  },
  { key: 'lts', name: 'Satiksmes stresa līmenis', description: 'Stresa līmeņi no 1 līdz 4' },
  { key: 'incompleteness', name: 'Datu trūkumi', description: null },
]
